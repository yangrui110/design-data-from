...
// 部门管理
const queryDepartTreeList = (params)=>getAction("/system/user/getUserMenus",params);
...
const queryMyDepartTreeList = (params)=>getAction("/system/user/getUserMenus",params);
