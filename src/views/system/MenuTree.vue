    ...
    <a-col :md="12" :sm="24">
      <a-tabs defaultActiveKey="1">
        <a-tab-pane tab="基本信息" key="1" >
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form :form="form">
              ...
              <a-form-item
                ...
                :wrapperCol="wrapperCol"
                label="菜单编码">
                <a-input disabled placeholder="请输入菜单编码" v-decorator="['menuCode', validatorRules.menuCode ]"/>
              </a-form-item>
              ...
              <a-form-item
                ...
                :wrapperCol="wrapperCol"
                label="组件">
                <a-input placeholder="请输入组件" v-decorator="['component', {'initialValue':''}]"/>
              </a-form-item>
              <a-form-item
                :labelCol="labelCol"
                :wrapperCol="wrapperCol"
                label="图标">
                <a-input placeholder="请输入图标" v-decorator="['icon', {'initialValue':''}]"/>
              </a-form-item>
            </a-form>
          ...
          <a-card v-else >
            <a-empty>
              <span slot="description"> 请先选择一个菜单! </span>
            </a-empty>
          </a-card>
        </a-tab-pane>
    ...
    data() {
      return {
        ...
        url: {
          ...
          deleteBatch: '/system/menu/batchDelete',
    ...
    methods: {
      ...
      setValuesToForm(record) {
        this.$nextTick(() => {
          ...
          this.form.setFieldsValue(pick(record, 'menuName','sort',"parentId",'menuCode', 'menuVisitPath', 'component', 'mobile', 'icon'))
        })
      },
